...
INSERT INTO "Product" ("id", "name", "description", "price", "imageUrl", "category", "inStock", "createdAt", "updatedAt") VALUES
  ...
  ('prod-002', 'Mechanical Gaming Keyboard', 'RGB backlit mechanical keyboard with Cherry MX Blue switches, programmable macro keys, and durable aluminum frame. Perfect for gaming and typing enthusiasts.', 149.99, 'https://images.unsplash.com/photo-1541140532154-b024d1b2d8a4?w=500', 'Electronics', true, NOW(), NOW()),
  ...
  ('prod-019', 'Wireless Charging Pad', 'Sleek Qi-certified wireless charging pad with 15W fast charging, LED indicator, and anti-slip surface. Compatible with all Qi-enabled smartphones and earbuds.', 24.99, 'https://images.unsplash.com/photo-1586816879360-004f5b0c51e3?w=500', 'Electronics', true, NOW(), NOW()),
  ...
  ('prod-021', 'Noise-Cancelling Earbuds', 'True wireless earbuds with hybrid active noise cancellation, transparency mode, and spatial audio. IPX5 water-resistant with 8-hour battery plus 24-hour charging case.', 179.99, 'https://images.unsplash.com/photo-1590658268037-6bf12f032f55?w=500', 'Electronics', true, NOW(), NOW()),
  ...
  ('prod-023', 'Smart Thermostat', 'WiFi-enabled smart thermostat with learning capability, energy-saving mode, and remote control via app. Compatible with Alexa, Google Home, and Apple HomeKit.', 199.99, 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=500', 'Home & Kitchen', true, NOW(), NOW()),
